    ...
    return (
      <div>
        <div className="hero is-large">
          <div className="hero-body">
            <div className="container">
              <h1 className=" shadow-text title has-text-dark has-text-centered">
        ...
        <div className="hero is-large">
          <div className="hero-body">
            <div className="container">
              <h2 className=" shadow-text title has-text-dark has-text-centered">
                About
            </h2>
            <h2 className= "subtitle has-text-dark has-text-centered">
        ...
        <Button onClick={this.goToKC} className="has-text-centered">
            Enter KCMO
        </Button>
      </div>
    )
